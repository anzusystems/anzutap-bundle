...
return ECSConfig::configure()
    ...
    ->withSkip([
        VisibilityRequiredFixer::class => null, // broken, use after this is resolved https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/issues/8381
        TypeDeclarationSpacesFixer::class => null, // broken, use after this is resolved https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/issues/8381
        ...
        // Temporarily skip problematic file that causes infinite loop
        'src/Model/Enum/RenderContext.php',
    ])
